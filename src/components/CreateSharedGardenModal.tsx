      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900">Shared Garden</h2>
              ...
              {createStep === 'done' && (
                <div className="space-y-4">
                  <div className="bg-green-50 rounded-xl p-4 text-center">
                    ...
                    <p className="font-medium text-green-900 text-sm">{createdGardenName} is ready</p>
          ...
          {tab === 'restore' && (
            <>
              {restoreStep === 'form' && (
                <div className="space-y-4">
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Upload the <span className="font-medium text-gray-700">garden-key.json</span> file you downloaded when you first created or joined this garden.
                  </p>
                  ...
                  >
                    {keyFile ? (
                      <>
                        ...
                        <p className="text-xs text-green-600 mt-0.5">Tap to choose a different file</p>
                      </>
                    ) : (
                      <>
                        ...
                        <p className="text-sm text-gray-600">Choose garden key file</p>
                        <p className="text-xs text-gray-400 mt-0.5">Select your .json key file</p>
                      </>
                    )}
                  </button>
                  <input
                  ...
                  {keyFile && (
                    <div>
                      ...
                      />
                      <p className="text-xs text-gray-400 mt-1">Pre-filled from your key file. Change if needed.</p>
                    </div>
                  )}
              ...
              {restoreStep === 'working' && (
                <div className="flex flex-col items-center py-8 gap-3">
                  <div className="w-10 h-10 border-2 border-green-600 border-t-transparent rounded-full animate-spin" />
                  <p className="text-sm text-gray-500">Restoring your garden...</p>
                </div>
              )}
              ...
              {restoreStep === 'done' && (
                <div className="space-y-4">
                  <div className="bg-green-50 rounded-xl p-4 text-center">
                    ...
                    <p className="font-medium text-green-900 text-sm">{restoredGardenName} restored</p>
                    <p className="text-xs text-green-700 mt-1">Your garden has been restored from the key file.</p>
                  </div>
                  <button
              ...
              {restoreStep === 'already-exists' && (
                <div className="space-y-4">
                  <div className="bg-amber-50 rounded-xl p-4 text-center">
                    ...
                    <p className="text-xs text-amber-700 mt-1">This garden is already on your device.</p>
                  </div>
                  <button
                    onClick={() => { resetAll(); onCreated(restoredGardenId); }}
                    className="w-full flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-medium py-2.5 px-4 rounded-xl transition-colors text-sm"
